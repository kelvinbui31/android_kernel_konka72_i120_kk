...
#CREATE_PROJECT_INFO = 20140505101556
...
CUSTOM_KERNEL_ACCELEROMETER = mma8452q_auto kxtik1004_auto
...
#CUSTOM_MODEM = viettel_v8508_hspa_kk
...
KONKA_BUTTON_LIGHT = no
KONKA_CALL_TOP_FLOAT = no
KONKA_CAMERA_TOUCH_SHOT = no
KONKA_CONTACTS_FAST_SCROLL = no
KONKA_DEFAULT_SCREEN_BRIGHTNESS = no
KONKA_DIGITAL_CLOCK = no
KONKA_DISABLE_BATTERY_LOW_LIGHT = no
KONKA_DYNAMIC_CALENDAR = no
KONKA_FLASHLIGHT = no
KONKA_FM_PRESS_EARPHONE_KEY = no
KONKA_GAMMA_FUNCTION = no
KONKA_GYROCALIBRATION = no
KONKA_HIDE_APP = no
KONKA_LAUNCHER_ALLAPP_RIGHT = no
KONKA_LAUNCHER_APP_ORDER = no
KONKA_LAUNCHER_SMALL_ICON_SIZE = no
KONKA_LAUNCHER_SWITCH = no
KONKA_MULTISIM_MESSAGE_RINGTONE_SUPPORT = yes
KONKA_MULTISIM_RINGTONE_SUPPORT_BY_SLOT = yes
KONKA_MUSIC_PRESS_EARPHONE_KEY = no
KONKA_NOTIFICATION_LED = no
KONKA_PHONE_INCALL_UI_RELAYOUT = yes
KONKA_POWER_GLOBAL_DIALOG_MODIFY = no
KONKA_REBOOT_PRESS_POWER_KEY = yes
KONKA_SETTINGS_STORAGE_SHOW_MEMORY = no
KONKA_VERSION_CONTROL = no
KONKA_VOLUMEPANEL_MULTIVOLUMEPANEL = no
KONKA_WALLPAPER_CENTER = no
LCM_FAKE_HEIGHT = 0
LCM_FAKE_WIDTH = 0
LCM_HEIGHT = 800
LCM_WIDTH = 480
...
MTK_BT_SUPPORT = yes
MTK_BUILD_VERNO = SW01_KONKA_V850_2014_11_22
MTK_BWC_SUPPORT = yes
...
MTK_FSCK_TUNE = no
MTK_FT5XXX_FIRMWARE_UPDATE_SUPPORT = yes
MTK_FW_UPGRADE = no
...
MTK_INTERNAL_VERNO = KAAI125_RSC_Ru_En_1.12.922
